                    ...
                    {userInfo ? (
                        <form onSubmit={submitHandler}>
                            <div className="my-2">
                                ...
                                <select className="border rounded-lg p-2 xl:w-[40rem] text-black" id="rating" required value={rating} onChange={e => setRating(e.target.value)}>
            ...
            {activeTab === 2 && (
                ...
                <div>
                    {product.reviews.map((review) => (
                        <div key={review._id} 
                        className="bg-slate-200 p-4 rounded-lg xl:ml-[2rem] sm:ml-[0rem] xl:w-[50rem] sm:w-[24rem] mb-5">
